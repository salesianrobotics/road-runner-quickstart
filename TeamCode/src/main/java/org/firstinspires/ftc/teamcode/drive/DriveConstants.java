...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(35, 5, 10,
    ...
    public static double TRACK_WIDTH = 1.496063; // in
     ...
     * inches.
     */
    public static double MAX_VEL = 1217;
