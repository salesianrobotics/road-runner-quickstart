...
public abstract class AutonomousBotLeft extends StandardBot {
    /*
    ...
    // private static final String TFOD_MODEL_FILE  3= "/sdcard/FIRST/tflitemodels/CustomTeamModel.tflite";
    ...
    void initVuforia() {
        ...
        parameters.cameraName = hardwareMap.get(WebcamName.class, "LogitechWebcamLeft");
